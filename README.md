...
Encapsulates common/useful tasks as methods for general use
Requires some tools/methods from the basic Butt Template here: https://github.com/Snoresville/dota2buttemplate_fixed.

If you are new to modding, be sure to follow the instructions in the README. They are well-written and easy to follow.
...
[Game-Tracking for Up-To-Date DotA](https://github.com/SteamDatabase/GameTracking-Dota2/tree/master/game): This is useful for getting up-to-date key values for dota's existing items/abilities, looking at localization files, etc.
